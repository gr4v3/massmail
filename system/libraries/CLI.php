...
<!-- saved from url=(0076)https://github.com/philsturgeon/codeigniter-cli/raw/master/libraries/CLI.php -->
<html><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8"></head><body><pre style="word-wrap: break-word; white-space: pre-wrap;">&lt;?php if ( ! defined('BASEPATH')) exit('No direct script access allowed');
/**
